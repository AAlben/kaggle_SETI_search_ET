...
class EfficientNetV2(nn.Module):
    ...
    def __init__(self, backbone, out_dim):
        ...
        self.conv1_6_3 = nn.Conv2d(1, 3, kernel_size=3, stride=1, padding=3, bias=False)
...
if __name__ == '__main__':
    ...
    label_0_data = SnippetsDataset(TRAIN_DATA_PATH, LABELS_CSV, 0)
    ...
    label_1_data = SnippetsDataset(TRAIN_DATA_PATH, LABELS_CSV, 1)
    ...
    test_data = SnippetsDatasetTest(TEST_DATA_PATH, 'test')
